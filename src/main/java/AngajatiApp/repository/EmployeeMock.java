...
public class EmployeeMock implements EmployeeRepositoryInterface {
	...
	public EmployeeMock() {
		...
		String mockCnp = "1234567890876";
		
		Employee Ionel = new Employee("Marius", "Pacuraru", mockCnp, DidacticFunction.ASSISTANT, 2500d);
		Employee Mihai = new Employee("Ion", "Dumitrescu", mockCnp, DidacticFunction.LECTURER, 2500d);
		Employee Ionela = new Employee("Gicu", "Ionescu", mockCnp, DidacticFunction.LECTURER, 2500d);
		Employee Mihaela = new Employee("Dodel", "Pacuraru", mockCnp, DidacticFunction.ASSISTANT, 2500d);
		Employee Vasile = new Employee("Dorel", "Georgescu", mockCnp, DidacticFunction.PROFESSOR, 2500d);
		Employee Marin   = new Employee("Larson", "Puscas", mockCnp, DidacticFunction.PROFESSOR,  2500d);
