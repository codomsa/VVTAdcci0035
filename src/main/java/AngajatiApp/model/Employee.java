...
public class Employee {
	...
	public static Employee getEmployeeFromString(String employeeString, int line) throws EmployeeException {
		...
		if (attributes.length != 6) {
			...
			if (attributes[DIDACTIC_FUNCTION_INDEX].equals("ASSISTANT"))
			...
			if (attributes[DIDACTIC_FUNCTION_INDEX].equals("PROFESSOR"))
				employee.setFunction(DidacticFunction.PROFESSOR);
			if (attributes[DIDACTIC_FUNCTION_INDEX].equals("ASSOCIATE"))
				employee.setFunction(DidacticFunction.ASSOCIATE);
